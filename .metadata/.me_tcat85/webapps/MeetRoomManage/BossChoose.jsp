...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script src="Scripts/getBossMeeting.js"></script>
    <script>
    </script>
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-29" data-genuitec-path="/MeetRoomManage/WebRoot/BossChoose.jsp">
        <div id="toolbar" class="btn-group" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-29" data-genuitec-path="/MeetRoomManage/WebRoot/BossChoose.jsp">
            <button id="btn_Choose" type="button" class="btn btn-default">
                <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>选定会议时间
            </button>
        </div>
